...
export function FhirExportPage() {
  ...
  const sources: FhirSourceRecord[] = useMemo(() => {
    const result: FhirSourceRecord[] = []
  ...
  return (
    <RequirePermission permission="export.fhir">
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Exportación FHIR R4</h1>
        <p className="mt-1 text-sm text-slate-600">
          Genere un Bundle FHIR con Patient, Encounter, Condition, Procedure y Composition
          a partir de historias clínicas firmadas. Compatible con interoperabilidad IHCE/RDA.
        </p>
      ...
      <div className="card space-y-4">
        <h2 className="text-base font-semibold text-slate-800">1. Seleccionar atenciones</h2>
      ...
      <div className="card space-y-4">
        <h2 className="text-base font-semibold text-slate-800">2. Opciones y exportar</h2>
        <FhirExportForm
          sources={sources}
          professional={user}
          onExported={() =>
